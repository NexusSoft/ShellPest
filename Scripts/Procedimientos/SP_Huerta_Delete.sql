...
BEGIN
	...
	begin try
		...
		declare @Activo bit
		select @Activo=Activa_Huerta from dbo.t_Huerta where Id_Huerta=@Id_Huerta
		
		if @Activo=1
			update dbo.t_Huerta set Activa_Huerta=0 where Id_Huerta=@Id_Huerta
		else
			update dbo.t_Huerta set Activa_Huerta=1 where Id_Huerta=@Id_Huerta
