...
GO
IF  EXISTS (SELECT * FROM SYS.OBJECTS WHERE TYPE = 'P' AND NAME = 'SP_Pantallas_Select')
DROP PROCEDURE SP_Pantallas_Select
GO
-- =============================================
-- Author:		<Author,,Name>
...
-- =============================================
CREATE PROCEDURE SP_Pantallas_Select
