...
{
    public class CLS_Inventum :ConexionBase
    {
        ...
        public void MtdInsertInvInicial()
        {
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Impor_InvIni_Inventum_Insert";
        ...
        public void MtdExistenciasProSelect()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_WS_Control_ExistenciaPro_Select";
        ...
        public void MtdExistenciasProAlmSelect()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
        ...
        public void MtdCosCampoSelect()
        {
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_CosCampo_Select";
                _dato.CadenaTexto = c_codigo_eps;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "c_codigo_eps");
                _conexion.EjecutarDataset();
        ...
        public void MtdCosActividadSelect()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
