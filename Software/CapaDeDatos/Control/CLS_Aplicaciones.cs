...
namespace CapaDeDatos
{
    public class CLS_Aplicaciones : ConexionBase
    {
        ...
        public decimal No_aplicaciones { get; set; }
        ...
        public void MtdSeleccionarRecetasDetalle()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Aplicacion_RecetaDet_Select";
                _dato.CadenaTexto = Id_Huerta;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Id_Huerta");
        ...
        public void MtdInsertarAplicaciones()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                ...
                _dato.DecimalValor = No_aplicaciones;
                _conexion.agregarParametro(EnumTipoDato.Tipodecimal, _dato, "No_aplicaciones");
                _dato.CadenaTexto = Fecha;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Fecha");
        ...
        public void MtdUpdateAplicaciones()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Aplicacion_Update";
        ...
        public void MtdInsertarAplicacionesReceta()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Aplicacion_Receta_Insert";
                _dato.CadenaTexto = Id_Aplicacion;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Id_Aplicacion");
                _dato.CadenaTexto = Id_Huerta;
                _conexion.agregarParametro(EnumTipoDato.CadenaTexto, _dato, "Id_Huerta");
