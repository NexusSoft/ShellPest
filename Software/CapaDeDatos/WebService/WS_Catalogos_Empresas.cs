...
{
    public class WS_Catalogos_Empresas : ConexionBase
    {
        ...
        public void MtdSeleccionarEmpresa()
        {
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_WS_Catalogos_conempresa_Select";
        ...
        public void MtdSeleccionarUsuarioEmpresa()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
