...
namespace CapaDeDatos
{
    public class CLS_Huerta : ConexionBase
    {
        ...
        public void MtdSeleccionarHuertaUsuarios()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
        ...
        public void MtdSeleccionarHuertaCorto()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
            ...
            try
            {
                _conexion.NombreProcedimiento = "SP_Huerta_Corto_Select";
        ...
        public void MtdSeleccionarHuertaMasCorto()
        {
            TipoDato _dato = new TipoDato();
            Conexion _conexion = new Conexion(cadenaConexion);
